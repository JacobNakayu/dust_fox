...
# Functions
from scan_functions import runScan, deleteFiles, openFiles, excludeFiles
...
class ScanPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        # Button to run scan
        scan_button = ttk.Button(self, text="Scan for Old Files", command=lambda: runScan())
        scan_button.grid(row=0, column=0, columnspan=3, pady=10)
        
        # Results widget
        results_frame = ScrollableFrame(self, 500, 0)
        results_frame.grid(row=1, column=0, columnspan=3, padx=10, sticky="we")
